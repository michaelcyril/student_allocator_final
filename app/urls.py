...
urlpatterns = [
    ...
    path("check_student_allocation", location.SingleStudentSchool, name="check_stu_alloc"),
    ...
    path("students_allocated/<school_id>", location.GetStudents, name="get_school_student"),
    ...
    path("schools_ad/<wilaya_id>", location.adminGetSchools, name="get_district_wards_ad"),
    path("students_allocated_ad/<school_id>", location.adminGetStudents, name="get_school_student_ad"),
